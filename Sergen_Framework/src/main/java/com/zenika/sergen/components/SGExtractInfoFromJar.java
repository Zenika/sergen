...
public class SGExtractInfoFromJar {
    ...
    public String getComponentDescription(String componentName) throws ClassNotFoundException {
    ...
    public String getComponentVersion(String componentName) throws ClassNotFoundException {
        Class clazz = Class.forName(componentName);
        SGComponentClassAnnotation annotation = (SGComponentClassAnnotation) clazz.getAnnotation(SGComponentClassAnnotation.class);
    ...
    public SG_COMPONENT_TYPE getComponentType(String componentName) throws ClassNotFoundException {
        Class clazz = Class.forName(componentName);
        SGComponentClassAnnotation annotation = (SGComponentClassAnnotation) clazz.getAnnotation(SGComponentClassAnnotation.class);
    ...
    public List<SGComponentMethod> getSGComponentMethods(String componentName) throws ClassNotFoundException {
        Method[] methods = getClassMethod(componentName);
